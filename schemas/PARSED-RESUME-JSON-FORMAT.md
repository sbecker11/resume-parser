...
**Schema:** Machine-readable validation is defined in `parsed-resume-format.json` (JSON Schema). Python validator: `validate_parsed_resume.py`.
...
- **Schema**: See `parsed-resume-format.json` for machine-readable validation. Python validator: `validate_parsed_resume.py`.
